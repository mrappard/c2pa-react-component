...
import { C2paManifestProps, DisclosureLevel } from '../../types'
...
export const C2paManifest: React.FC<C2paManifestProps> = ({ manifest, level = 3, className, onViewMore,   defaultViewMore }) => {
  ...
  switch (levelOfDetail) {
    case 1: return <C2paManifestL1 manifest={manifest} activeManifest={activeManifest} className={className} onViewMore={onViewMore ?? (defaultViewMore ? updateLevelOfDetail : undefined)} />
    case 2: return <C2paManifestL2 manifest={manifest} activeManifest={activeManifest} className={className} onViewMore={onViewMore ?? (defaultViewMore ? updateLevelOfDetail : undefined)} />
